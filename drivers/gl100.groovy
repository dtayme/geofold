...
protocol("gl100") {
    ...
    variant("position") {
        ...
        maxFrameLength 512
        frame '+' as char, readUntil("\0")

        matches { msg -> msg.startsWith('+RESP:GT') }
    ...
    variant("heartbeat") {
        ...
        maxFrameLength 512
        frame 'A' as char, readUntil("\0")

        matches { msg -> msg.startsWith('AT+GTHBD=') }
